...
DROP TRIGGER IF EXISTS trg_notify_push_order ON public.orders;
CREATE TRIGGER trg_notify_push_order
  AFTER INSERT ON public.orders
  FOR EACH ROW EXECUTE FUNCTION public.notify_push_order();

DROP TRIGGER IF EXISTS trg_notify_push_maintenance ON public.maintenance_requests;
CREATE TRIGGER trg_notify_push_maintenance
  AFTER INSERT ON public.maintenance_requests
  FOR EACH ROW EXECUTE FUNCTION public.notify_push_maintenance();
