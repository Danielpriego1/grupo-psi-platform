...
export default function Privacidad() {
  return (
    <>
      <SEO
        title="Aviso de Privacidad | Grupo Psi"
        description="Aviso de privacidad de Grupo Psi. Conoce cómo protegemos y tratamos tus datos personales conforme a la legislación mexicana."
        path="/privacidad"
      />
